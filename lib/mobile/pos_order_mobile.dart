...
class PosOrderMobile extends StatefulWidget {
  @override
  _PosOrderMobileState createState() => _PosOrderMobileState();
}

class _PosOrderMobileState extends State<PosOrderMobile> {
                                            ...
                                            subtitle: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  children: [
                                                    Icon(Icons.schedule_outlined, size: 20.0),
                                                    Poppins(
                                                ...
                                                GradientText(
                                                  text: "Rp. ${format(getTotalPrice(order).toString())}",
